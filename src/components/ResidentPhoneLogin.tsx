  ...
  return (
    <div className="min-h-screen bg-[#0b1118] text-[#e2e8f0] flex items-center justify-center px-4">
      <form onSubmit={submit} className="w-full max-w-sm rounded-3xl border border-[#223040] bg-[#0f1722] p-6 shadow-2xl">
        ...
        {onBack && (
          <button type="button" onClick={onBack} className="mt-3 w-full rounded-2xl border border-[#223040] py-2 text-xs font-semibold text-[#e2e8f0]">Back</button>
        )}
        {error && (
          <div className="mt-3 flex items-start gap-2 rounded-xl border border-rose-700 bg-rose-950/80 p-3 text-xs text-rose-300">
