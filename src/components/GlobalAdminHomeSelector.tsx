    ...
    <div className="min-h-screen bg-[#0f1722] flex flex-col items-center justify-center p-6">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Select a Home</h1>
          <p className="text-sm text-white">Choose a facility to view its weekly stats and manage staff/residents.</p>
        </div>
        ...
        <div className="bg-[#0f1722] rounded-2xl border border-[#1e293b] shadow-sm p-6 space-y-4">
          ...
          <div className="space-y-2">
            {homes.map((home) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-white">{home.location || 'No location'} · ID: {home.id}</p>
                </div>
                {selectedHomeId === home.id && (
            ...
            {!homes.length && (
              <p className="text-xs text-white text-center py-4">No homes found. Create a home first.</p>
            )}
          </div>
          ...
          <button
            ...
            className="w-full mt-4 px-4 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm disabled:opacity-50 transition flex items-center justify-center gap-2"
          >
