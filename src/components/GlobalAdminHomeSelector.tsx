    ...
    <div className="min-h-screen bg-[#0f1722] flex flex-col items-center justify-center p-6">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#cbd5e1]">Choose a facility to view its weekly stats and manage staff/residents.</p>
        </div>
        ...
        <div className="bg-[#0f1722] rounded-2xl border border-[#1e293b] shadow-sm p-6 space-y-4">
          ...
          <div className="space-y-2">
            {homes.map((home) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-[#cbd5e1]">{home.location || 'No location'} · ID: {home.id}</p>
                </div>
                {selectedHomeId === home.id && (
            ...
            {!homes.length && (
              <p className="text-xs text-[#cbd5e1] text-center py-4">No homes found. Create a home first.</p>
            )}
          </div>
