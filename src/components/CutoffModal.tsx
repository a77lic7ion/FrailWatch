...
export const CutoffModal: React.FC<CutoffModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#0b1118]/70 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-[#0f1722] rounded-3xl p-6 max-w-sm w-full shadow-2xl border border-[#1e293b] text-[#e2e8f0] animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="py-5 space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            <button
              type="submit"
              className="flex-1 py-3 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-[#e2e8f0] font-bold text-xs transition flex items-center justify-center gap-1.5"
            >
